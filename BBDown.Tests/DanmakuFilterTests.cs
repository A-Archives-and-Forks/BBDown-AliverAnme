...
{
    private static DanmakuUtil.DanmakuItem Make(string content, string uid = "10001")
        => new(["1", "1", "25", "16777215", uid], content);
    ...
    [Fact]
    public void Filter_User_RemovesThatUsersDanmaku()
    {
