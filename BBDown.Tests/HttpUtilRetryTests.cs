...
/// <summary>
/// C4：API 层统一重试 + "200+HTML 风控页"识别。
/// GetWebSourceAsync/GetPostResponseAsync 仅对 5xx 与传输层失败（HttpRequestException）
/// 按 MaxRetryCount 指数退避重试；4xx 风控/参数错不重试；200+HTML 抛
/// RiskControlResponseException 替代下游 JsonException/grpc 乱码。
/// </summary>
